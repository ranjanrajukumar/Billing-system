...
export const DEFAULT_TEMPLATES = [
  ...
  {
    templateName: 'Premium Quotation',
    invoiceTitle: 'QUOTATION',
    paperSize: 'A4',
    declaration: 'We are pleased to submit the above quotation for your consideration. Prices are valid until the specified validity date.',
    footerMessage: 'If you have any questions concerning this quotation, please contact us.',
    authorizedSignatory: 'Authorized Representative',
    designLayout: [
      block('t6-1', 'quoteHeader', { showLogo: true, showAddress: true }),
      block('t6-2', 'spacer', { height: 20 }),
      block('t6-3', 'quoteParties', { showGst: true, showAddress: true }),
      block('t6-4', 'spacer', { height: 20 }),
      block('t6-5', 'items', { showSerial: true, showHsn: false, showAmounts: true, showDiscount: true, showGst: true }),
      block('t6-6', 'spacer', { height: 10 }),
      block('t6-7', 'totals', { showTaxBreakup: true, showRoundOff: true }),
      block('t6-8', 'amountWords'),
      block('t6-9', 'spacer', { height: 30 }),
      block('t6-10', 'terms'),
      block('t6-11', 'signature'),
      block('t6-12', 'footer'),
    ],
  },
];
