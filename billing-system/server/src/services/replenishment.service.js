 ...
 */
export function applyOrderRules(required, policy) {
 ...
 */
export async function fetchIncomingStock(branchId = null) {
  const replacements = {};
  let poFilter = '';
  let transferFilter = '';
  if (branchId) {
...
export async function fetchStockPositions(branchId = null) {
  const replacements = {};
