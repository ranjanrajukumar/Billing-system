...
router.post('/accounts', authorize('Admin', 'Accountant'), controller.createAccount);
router.put('/accounts/:id', authorize('Admin', 'Accountant'), controller.updateAccount);
...
router.post('/entries', authorize('Admin', 'Accountant'), controller.createEntry);
