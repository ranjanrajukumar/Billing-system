...
export default function Warehouses() {
  ...
  // Name and code both, because the code is what every document prints and
  // every import matches on. The address genuinely is optional.
  const locationFields = useRequiredFields([
    { name: 'branchName', label: 'Location name' },
    { name: 'branchCode', label: 'Code' },
  ]);
  ...
  const saveWarehouse = async () => {
    if (!locationFields.check(editing, showToast)) return;
