          ...
          <Stack spacing={4} component="form" onSubmit={handleSubmit(submit)}>
            <Paper variant="outlined" sx={{ p: 3, borderRadius: 3, bgcolor: 'background.default', border: '1px solid', borderColor: 'divider' }}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <TextField fullWidth type="date" label="Quotation Date" required {...register('quotationDate', requiredRule('Quotation date'))} InputLabelProps={{ shrink: true }} sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }} />
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
            ...
            <Box sx={{ px: 1 }}>
              <LineItems
            showErrors={lineErrors} items={items} onChange={setItems} products={products} blank={blankItem} />
            </Box>
