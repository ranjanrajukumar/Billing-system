      ...
      <Modal open={open} title="New Delivery Challan" onClose={() => setOpen(false)} maxWidth="md">
        <Stack spacing={2.5} component="form" onSubmit={handleSubmit(submit)}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={3}>
              <TextField fullWidth type="date" label="Challan Date" required {...register('challanDate', requiredRule('Challan date'))} InputLabelProps={{ shrink: true }} />
            </Grid>
            <Grid item xs={12} sm={3}>
          ...
          <LineItems
            showErrors={lineErrors} items={items} onChange={setItems} products={products} fields={[]} blank={blankItem} />
