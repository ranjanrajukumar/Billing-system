        ...
        <SectionCard title="Account Information" icon={<PersonIcon fontSize="small" />}>
          <Grid container spacing={2} component="form" onSubmit={handleSubmit(submit)}>
            <Grid item xs={12} sm={6}>
              <TextField fullWidth label="Full Name" required {...register('name', { required: true })} InputLabelProps={{ shrink: true }} />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField fullWidth type="email" label="Email Address" required {...register('email', { required: true })} InputLabelProps={{ shrink: true }} />
            </Grid>
            <Grid item xs={12} sm={6}>
