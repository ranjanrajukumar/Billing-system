...
export default function Grn() {
  ...
  // A receipt has to say when it arrived and where it landed. The purchase
  // order does not: a direct receipt has none.
  const grnFields = useRequiredFields([
    { name: 'grnDate', label: 'GRN date' },
  ...
  const submit = async () => {
    if (!grnFields.check(creating, showToast)) return;
        ...
        {creating && (
          <Stack spacing={2}>
            ...
            <Grid container spacing={1.5}>
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  select fullWidth size="small" label="Received at" {...grnFields.fieldProps('branchId', creating)} value={creating.branchId || ''}
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  fullWidth size="small" type="date" label="Receipt date" {...grnFields.fieldProps('grnDate', creating)} value={creating.grnDate}
