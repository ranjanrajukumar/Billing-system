      ...
      <Modal open={open} title="Record Purchase" onClose={() => setOpen(false)} maxWidth="lg">
        <Stack spacing={2.5} component="form" onSubmit={handleSubmit(submit)}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              <TextField fullWidth type="date" label="Purchase Date" required {...register('purchaseDate', requiredRule('Purchase date'))} InputLabelProps={{ shrink: true }} />
            </Grid>
            <Grid item xs={12} sm={4}>
          ...
          <LineItems
            showErrors={lineErrors} items={items} onChange={setItems} products={products} fields={['rate', 'gstPercent']} showBatchFields={true} blank={blankItem} />
