...
const masterDataForms = {
  ...
  unit:            { title: 'Unit Master',             description: 'Units such as pcs, kg, box, meter, and service.',            api: makeMasterDataResource('unit'),            empty: { code: '', name: '', precision: 0 },             fields: [text('code', 'Unit Code'), text('name', 'Unit Name'), number('precision', 'Decimal Precision', false)] },
