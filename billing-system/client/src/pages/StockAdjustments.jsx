        ...
        {creating && (
          <Stack spacing={2}>
            ...
            <Grid container spacing={1.5}>
              <Grid item xs={12} sm={4}>
                <TextField
                  select fullWidth size="small" label="Location" value={creating.branchId}
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  select fullWidth size="small" label="Reason" value={creating.reason}
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  fullWidth size="small" type="date" label="Date" value={creating.adjustmentDate}
