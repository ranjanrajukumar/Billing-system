...
import OrderFulfilment from '../components/OrderFulfilment.jsx';
import PutAwayRules from '../components/PutAwayRules.jsx';
    ...
    <Stack spacing={3} className="animate-fadeInUp">
      ...
      <Modal open={Boolean(placing)} title="Put away" onClose={() => setPlacing(null)} maxWidth="xs">
        {placing && (
          <Stack spacing={2}>
            ...
            <TextField
              select fullWidth size="small" label="Into bin" value={placing.binId}
            ...
            <TextField
              fullWidth size="small" type="number" label="Quantity" value={placing.quantity}
      ...
      <Modal open={Boolean(moving)} title="Move between bins" onClose={() => setMoving(null)} maxWidth="xs">
        {moving && (
          <Stack spacing={2}>
            <TextField
              select fullWidth size="small" label="From bin" value={moving.fromBinId}
            ...
            <TextField
              select fullWidth size="small" label="To bin" value={moving.toBinId}
            ...
            <TextField
              fullWidth size="small" type="number" label="Quantity" value={moving.quantity}
