        ...
        {creating && (
          <Stack spacing={3}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <SearchableSelect
                  label="Supplier (Optional)" options={suppliers}
                  value={creating.supplierId} onChange={(v) => setCreating({ ...creating, supplierId: v })}
                  getOptionLabel={(o) => o.supplierName} getOptionValue={(o) => o.id}
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
            ...
            <DocumentLines
              lines={creating.items} catalogue={products}
              onChange={(items) => setCreating({ ...creating, items })}
              columns={[
                { key: 'productId', label: 'Product', type: 'product', required: true },
                { key: 'quantity', label: 'Qty', type: 'number', required: true, width: '100px' },
